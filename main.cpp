...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Master Akshay"<<endl;
        string phrase = "Good Morning Master Akshay";
        ...
        cout<< "Good Afternoon Master Akshay"<<endl;
        string phrase = "Good Afternoon Master Akshay";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Master Akshay"<<endl;
        string phrase = "Good Evening Master Akshay";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER AKSHAY|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER AKSHAY";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="akshay")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Master Akshay...."<<endl<<endl;

                string phrase = "How can i help you Master Akshay";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Master Akshay....."<<endl;
                    string phrase = "Hello Master Akshay";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                else if(command=="who are you" || command=="who is speaking")
                {
                    ...
                    string phrase = "I'm a personal assistant created by Master Akshay !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"Good Bye Master Akshay, see you soon!"<<endl;
                    string phrase = "Good Bye Master Akshay see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
